...
<div id="header">
	<div class="back" onclick="location.replace('./')" ></div>
	...
	<script type="text/javascript">
     function prevday() {
        <?php
        if ($y == 1) {
            echo 'location.replace("trip.php?x='.$x.'&day=1")';
        } else if ($y == 2) {
            echo 'location.replace("trip.php?x='.$x.'&day=2")';
        }
        ?>
     }   
    ...
    function nextday() {
        <?php
        if ($y < 2) {
            echo 'location.replace("trip.php?x='.$x.'&day='.($y+2).'")';
        }
        ?>
     }   
    </script>
...
<?php 
	if (count($dayone_acts) > 0) {
		...
		for ($o = 0; $o < count($dayone_acts); $o++) {
            ...
            echo '<div class="t">'; 
                echo '<div class="time">'; 
                    echo '<h3>'; echo $dayone_acts[$o]['from']; echo '</h3>';
                    echo '<h4>'; echo $dayone_acts[$o]['to']; echo '</h4>';
                echo '</div>';
                echo '<div class="line">'; echo '</div>';
                echo '<h1>'; echo $dayone_acts[$o]['activity']; echo '</h1>';
                echo '<br>';
                echo '<p>'; echo $dayone_acts[$o]['desc']; echo '</p>';
			echo '</div>';
		}
	} else {
		echo "Hari bebas";
